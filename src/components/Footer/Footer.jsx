...
function Footer() {
  return (
    <section
  className="relative overflow-hidden py-10 border border-t-2 border-t-black bg-[url('https://tse2.mm.bing.net/th/id/OIP.iDN_Vgp7csLhucxdjs6C9wHaB2?pid=Api&P=0&h=180')] bg-cover bg-center"
>
